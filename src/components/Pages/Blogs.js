...
const Blogs = () => {
    ...
    return (
        <div>
            <h1 className='w-full text-3xl border-b-4 mb-5 p-10'>Blogs page</h1>
            ...
            <div className='q-1'>
                ...
                <div className='q-4'>
                    ...
                    <div>
                        <span className='font-bold'>Ans. :</span>
                    <h1>নিম্নলিখিত কারণগুলির কারণে একজনকে কখনই সরাসরি state আপডেট করা উচিত নয়:</h1>
                    <ol>
                        <li>আপনি যদি এটি সরাসরি আপডেট করেন, তাহলে setState() কে পরে call করলে আপনার করা আপডেটটি বদলে যেতে পারে</li>
                        <li>আপনি যখন state-কে সরাসরি আপডেট করেন, তখন এটি অবিলম্বে this.state পরিবর্তন করে না। পরিবর্তে, এটি একটি pending অবস্থার রূপান্তর তৈরি করে এবং এই পদ্ধতিতে call করার পরে এটি access করা শুধুমাত্র বর্তমান মান ফিরিয়ে দেবে</li>
                        <li>আপনি সমস্ত components-এর state নিয়ন্ত্রণ হারাবেন.</li>
